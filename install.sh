...
#   SYGEN_CORE_VERSION        default: 1.6.91 — version of `sygen` Python
#                             package to install (or "latest" to query
#                             GitHub Releases for the latest tag).
#   SYGEN_ADMIN_VERSION       default: 0.5.62 — version of sygen-admin
...
CORE_VERSION="${SYGEN_CORE_VERSION:-1.6.91}"
ADMIN_VERSION="${SYGEN_ADMIN_VERSION:-0.5.62}"
